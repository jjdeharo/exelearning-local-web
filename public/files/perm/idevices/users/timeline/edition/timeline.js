var $exeDevice = {
    i18n: {
        es: {
            ...
            sampleTitle: 'Teoria de la Evolucion',
            sampleIntro: 'Linea temporal rigurosa sobre los principales hitos en la construccion de la teoria de la evolucion, desde las primeras propuestas transformistas hasta la base molecular de la herencia.',
            sample1Date: '1809',
            sample1Title: 'Lamarck y el Transformismo',
            sample1Text: 'Jean-Baptiste Lamarck defendio que las especies cambian con el tiempo. Propuso que el uso y desuso de los organos y la herencia de caracteres adquiridos explicaban esos cambios. Aunque su mecanismo no se acepta hoy, fue importante porque nego la idea de que las especies fueran inmutables.',
            sample2Date: '1831-1836',
            sample2Title: 'Viaje del Beagle',
            sample2Text: 'Charles Darwin viajo alrededor del mundo a bordo del HMS Beagle. Durante esta expedicion observo fosiles, especies de distintos continentes y la fauna de las islas Galapagos. Estas observaciones le llevaron a pensar que las especies podian cambiar y diversificarse con el tiempo.',
            sample3Date: '1858',
            sample3Title: 'Darwin y Wallace Presentan la Seleccion Natural',
            sample3Text: 'Charles Darwin y Alfred Russel Wallace presentaron de forma conjunta la idea de la seleccion natural. Ambos sostuvieron que los individuos con variaciones favorables tienen mas probabilidad de sobrevivir y dejar descendencia, de modo que esas caracteristicas se hacen mas frecuentes en la poblacion.',
            ...
            prompt4: 'Reglas obligatorias: incluye al menos una imagen y al menos un video; asegurate de que las URLs de imagen y video existan realmente antes de devolverlas; escapa las comillas internas dentro de los textos; no uses enlaces en formato markdown [texto](url); en mediaSrc y videoUrl escribe solo una URL limpia que empiece por https://; no escribas corchetes ni parentesis en las URLs; si incluyes un video externo, pon solo la URL limpia en videoUrl; si no hay medio, usa mediaType="none" y deja vacios mediaSrc, videoUrl y posterSrc.',
        ...
        en: {
            ...
            sampleTitle: 'Theory of Evolution',
            sampleIntro: 'A rigorous timeline of the main milestones in the construction of evolutionary theory, from the first transformist proposals to the molecular basis of inheritance.',
            sample1Date: '1809',
            sample1Title: 'Lamarck and Transformism',
            sample1Text: 'Jean-Baptiste Lamarck argued that species change over time. He proposed that use and disuse of organs and the inheritance of acquired traits explained those changes. Although his mechanism is not accepted today, it was important because it challenged the idea that species were immutable.',
            sample2Date: '1831-1836',
            sample2Title: 'Voyage of the Beagle',
            sample2Text: 'Charles Darwin travelled around the world aboard the HMS Beagle. During this expedition he observed fossils, species from different continents and the fauna of the Galapagos Islands. These observations led him to think that species could change and diversify over time.',
            sample3Date: '1858',
            sample3Title: 'Darwin and Wallace Present Natural Selection',
            sample3Text: 'Charles Darwin and Alfred Russel Wallace jointly presented the idea of natural selection. Both argued that individuals with favourable variations are more likely to survive and leave offspring, so those traits become more common in the population.',
            ...
            prompt4: 'Mandatory rules: include at least one image and at least one video; make sure the image and video URLs really exist before returning them; escape internal quotes inside texts; do not use markdown links [text](url); in mediaSrc and videoUrl write only a clean URL starting with https://; do not write brackets or parentheses inside URLs; if you include an external video, put only the clean URL in videoUrl; if there is no media, use mediaType="none" and leave mediaSrc, videoUrl and posterSrc empty.',
        ...
        ca: {
            ...
            sampleTitle: 'Teoria de l Evolucio',
            sampleIntro: 'Linia temporal rigorosa sobre les principals fites en la construccio de la teoria de l evolucio, des de les primeres propostes transformistes fins a la base molecular de l herencia.',
            sample1Date: '1809',
            sample1Title: 'Lamarck i el Transformisme',
            sample1Text: 'Jean-Baptiste Lamarck va defensar que les especies canvien amb el temps. Va proposar que l us i desus dels organs i l herencia de caracters adquirits explicaven eixos canvis. Encara que el seu mecanisme no s accepta hui, va ser important perque va negar la idea que les especies foren inmutables.',
            sample2Date: '1831-1836',
            sample2Title: 'Viatge del Beagle',
            sample2Text: 'Charles Darwin va viatjar al voltant del mon a bord de l HMS Beagle. Durant esta expedicio va observar fossils, especies de distints continents i la fauna de les illes Galapagos. Estes observacions el van portar a pensar que les especies podien canviar i diversificar-se amb el temps.',
            sample3Date: '1858',
            sample3Title: 'Darwin i Wallace Presenten la Seleccio Natural',
            sample3Text: 'Charles Darwin i Alfred Russel Wallace van presentar de manera conjunta la idea de la seleccio natural. Tots dos sostenien que els individus amb variacions favorables tenen mes probabilitat de sobreviure i deixar descendencia, de manera que eixes caracteristiques es fan mes frequents en la poblacio.',
    ...
    getFormHtml: function () {
        ...
        return (
            ...
            '<div class="timeline-event-toolbar"><button type="button" class="timeline-clear-events" id="timelineClearEvents">' + this.t('clearEvents') + '</button></div>' +
            ...
            '<div class="timeline-event-toolbar"><button type="button" class="timeline-add-event" id="timelineAddEvent">' + this.t('addEvent') + '</button></div>' +
            '</fieldset>' +
            '</div>' +
            ...
            es: [
                {
                    displayDate: '1809',
                    sortKey: '1809',
                    title: 'Lamarck y el Transformismo',
                    text: 'Jean-Baptiste Lamarck defendio que las especies cambian con el tiempo. Propuso que el uso y desuso de los organos y la herencia de caracteres adquiridos explicaban esos cambios. Aunque su mecanismo no se acepta hoy, fue importante porque nego la idea de que las especies fueran inmutables.',
                    feedback: 'Este hito es importante porque introduce una explicacion evolutiva, aunque el mecanismo propuesto por Lamarck no coincide con el conocimiento cientifico actual.',
                    mediaType: 'image',
                    mediaSrc: 'https://commons.wikimedia.org/wiki/Special:FilePath/Jean-Baptiste%20de%20Lamarck.jpg',
                    videoSource: 'local',
                    videoUrl: '',
                    posterSrc: '',
                    mediaCaption: 'Retrato de Jean-Baptiste Lamarck',
                },
                {
                    displayDate: '1831-1836',
                    sortKey: '1831',
                    title: 'Viaje del Beagle',
                    text: 'Charles Darwin viajo alrededor del mundo a bordo del HMS Beagle. Durante esta expedicion observo fosiles, especies de distintos continentes y la fauna de las islas Galapagos. Estas observaciones le llevaron a pensar que las especies podian cambiar y diversificarse con el tiempo.',
                    feedback: 'Conviene relacionar este viaje con la acumulacion de observaciones que llevaron a Darwin a formular su explicacion evolutiva.',
                    mediaType: 'image',
                    mediaSrc: 'https://commons.wikimedia.org/wiki/Special:FilePath/HMS%20Beagle%20by%20Conrad%20Martens.jpg',
                    videoSource: 'local',
                    videoUrl: '',
                    posterSrc: '',
                    mediaCaption: 'Pintura del HMS Beagle',
                },
                {
                    displayDate: '1858',
                    sortKey: '1858',
                    title: 'Darwin y Wallace Presentan la Seleccion Natural',
                    text: 'Charles Darwin y Alfred Russel Wallace presentaron de forma conjunta la idea de la seleccion natural. Ambos sostuvieron que los individuos con variaciones favorables tienen mas probabilidad de sobrevivir y dejar descendencia, de modo que esas caracteristicas se hacen mas frecuentes en la poblacion.',
                    feedback: 'Recuerda que Wallace llego de manera independiente a una idea muy similar a la de Darwin.',
                    mediaType: 'none',
                    mediaSrc: '',
                    videoSource: 'local',
                    videoUrl: '',
                ...
                },
                {
                    displayDate: '1859',
                    sortKey: '1859',
                    title: 'Publicacion de El Origen de las Especies',
                    text: 'Darwin publico "El origen de las especies", obra en la que explico que la evolucion ocurre por seleccion natural. En ella defendio que todas las especies descienden de antepasados comunes y que la biodiversidad actual es el resultado de cambios acumulados durante largos periodos de tiempo.',
                    feedback: 'Este es uno de los textos cientificos mas influyentes de la biologia porque aporta una explicacion general y coherente de la evolucion.',
                    mediaType: 'video',
                    mediaSrc: '',
                    videoSource: 'external',
                    videoUrl: 'https://www.youtube.com/watch?v=dyiZaHIRM6w',
                    posterSrc: '',
                    mediaCaption: 'Video divulgativo sobre Darwin y la seleccion natural',
                },
                {
                    displayDate: '1865',
                    sortKey: '1865',
                    title: 'Mendel Formula las Leyes de la Herencia',
                    text: 'Gregor Mendel publico los resultados de sus experimentos con guisantes. Sus leyes mostraron que los caracteres hereditarios se transmiten de forma definida entre generaciones. Decadas despues, este trabajo permitio comprender mejor como se conserva y se transmite la variabilidad biologica.',
                    feedback: 'La genetica mendeliana fue esencial para explicar como pueden heredarse las diferencias sobre las que actua la seleccion natural.',
                    mediaType: 'image',
                    mediaSrc: 'https://commons.wikimedia.org/wiki/Special:FilePath/Gregor%20Mendel%202%20%28cropped%29.jpg',
                    videoSource: 'local',
                    videoUrl: '',
                    posterSrc: '',
                    mediaCaption: 'Retrato de Gregor Mendel',
                },
                {
                    displayDate: '1930-1940',
                    sortKey: '1930',
                    title: 'Sintesis Moderna de la Evolucion',
                    text: 'Durante estas decadas se integraron la seleccion natural de Darwin y la genetica mendeliana. La sintesis moderna explico la evolucion como un cambio en la frecuencia de los alelos en las poblaciones a lo largo del tiempo e incorporo procesos como mutacion, recombinacion, deriva genetica y seleccion natural.',
                    feedback: 'Este momento une evolucion y genetica en una teoria mas completa, base de la biologia evolutiva actual.',
                    mediaType: 'image',
                    mediaSrc: 'https://commons.wikimedia.org/wiki/Special:FilePath/DNA%20double%20helix%20vertikal.PNG',
                    videoSource: 'local',
                    videoUrl: '',
                    posterSrc: '',
                    mediaCaption: 'Representacion de la doble helice del ADN, relacionada con la herencia biologica',
                },
            ],
            en: [
                {
                    displayDate: '1809',
                    sortKey: '1809',
                    title: 'Lamarck and Transformism',
                    text: 'Jean-Baptiste Lamarck argued that species change over time. He proposed that the use and disuse of organs and the inheritance of acquired traits explained those changes. Although his mechanism is not accepted today, it was important because it challenged the idea that species were immutable.',
                    feedback: 'This milestone matters because it introduces an evolutionary explanation, even though Lamarck s mechanism does not match current scientific knowledge.',
                    mediaType: 'image',
                    mediaSrc: 'https://commons.wikimedia.org/wiki/Special:FilePath/Jean-Baptiste%20de%20Lamarck.jpg',
                    videoSource: 'local',
                    videoUrl: '',
                    posterSrc: '',
                    mediaCaption: 'Portrait of Jean-Baptiste Lamarck',
                },
                {
                    displayDate: '1831-1836',
                    sortKey: '1831',
                    title: 'Voyage of the Beagle',
                    text: 'Charles Darwin travelled around the world aboard the HMS Beagle. During this expedition he observed fossils, species from different continents and the fauna of the Galapagos Islands. These observations led him to think that species could change and diversify over time.',
                    feedback: 'This voyage should be linked to the accumulation of observations that led Darwin to formulate his evolutionary explanation.',
                    mediaType: 'image',
                    mediaSrc: 'https://commons.wikimedia.org/wiki/Special:FilePath/HMS%20Beagle%20by%20Conrad%20Martens.jpg',
                    videoSource: 'local',
                    videoUrl: '',
                    posterSrc: '',
                    mediaCaption: 'Painting of the HMS Beagle',
                },
                {
                    displayDate: '1858',
                    sortKey: '1858',
                    title: 'Darwin and Wallace Present Natural Selection',
                    text: 'Charles Darwin and Alfred Russel Wallace jointly presented the idea of natural selection. Both argued that individuals with favourable variations are more likely to survive and leave offspring, so those traits become more common in the population.',
                    feedback: 'Remember that Wallace independently reached an idea very similar to Darwin s.',
                    mediaType: 'none',
                    mediaSrc: '',
                    videoSource: 'local',
                    videoUrl: '',
                ...
                },
                {
                    displayDate: '1859',
                    sortKey: '1859',
                    title: 'Publication of On the Origin of Species',
                    text: 'Darwin published "On the Origin of Species", a work in which he explained that evolution occurs through natural selection. He argued that all species descend from common ancestors and that today s biodiversity is the result of accumulated changes over long periods of time.',
                    feedback: 'This is one of the most influential scientific works in biology because it provides a broad and coherent explanation of evolution.',
                    mediaType: 'video',
                    mediaSrc: '',
                    videoSource: 'external',
                    videoUrl: 'https://www.youtube.com/watch?v=dyiZaHIRM6w',
                    posterSrc: '',
                    mediaCaption: 'Educational video about Darwin and natural selection',
                },
                {
                    displayDate: '1865',
                    sortKey: '1865',
                    title: 'Mendel Formulates the Laws of Inheritance',
                    text: 'Gregor Mendel published the results of his experiments with pea plants. His laws showed that hereditary traits are transmitted in a defined way across generations. Decades later, this work helped explain how biological variation is preserved and transmitted.',
                    feedback: 'Mendelian genetics was essential for explaining how the differences on which natural selection acts can be inherited.',
                    mediaType: 'image',
                    mediaSrc: 'https://commons.wikimedia.org/wiki/Special:FilePath/Gregor%20Mendel%202%20%28cropped%29.jpg',
                    videoSource: 'local',
                    videoUrl: '',
                    posterSrc: '',
                    mediaCaption: 'Portrait of Gregor Mendel',
                },
                {
                    displayDate: '1930-1940',
                    sortKey: '1930',
                    title: 'Modern Evolutionary Synthesis',
                    text: 'During these decades Darwin s natural selection and Mendelian genetics were integrated. The modern synthesis explained evolution as a change in allele frequencies in populations over time and incorporated processes such as mutation, recombination, genetic drift and natural selection.',
                    feedback: 'This moment joins evolution and genetics in a more complete theory, the basis of current evolutionary biology.',
                    mediaType: 'image',
                    mediaSrc: 'https://commons.wikimedia.org/wiki/Special:FilePath/DNA%20double%20helix%20vertikal.PNG',
                    videoSource: 'local',
                    videoUrl: '',
                    posterSrc: '',
                    mediaCaption: 'Representation of the DNA double helix, related to biological inheritance',
                },
            ],
            ca: [
                {
                    displayDate: '1809',
                    sortKey: '1809',
                    title: 'Lamarck i el Transformisme',
                    text: 'Jean-Baptiste Lamarck defensava que les especies canvien amb el temps. Va proposar que l us i desus dels organs i l herencia de caracters adquirits explicaven aquests canvis. Encara que el seu mecanisme no s accepta hui, va ser important perque negava la idea que les especies foren immutables.',
                    feedback: 'Aquesta fita es important perque introdueix una explicacio evolutiva, encara que el mecanisme proposat per Lamarck no coincideix amb el coneixement cientific actual.',
                    mediaType: 'image',
                    mediaSrc: 'https://commons.wikimedia.org/wiki/Special:FilePath/Jean-Baptiste%20de%20Lamarck.jpg',
                    videoSource: 'local',
                    videoUrl: '',
                    posterSrc: '',
                    mediaCaption: 'Retrat de Jean-Baptiste Lamarck',
                },
                {
                    displayDate: '1831-1836',
                    sortKey: '1831',
                    title: 'Viatge del Beagle',
                    text: 'Charles Darwin va viatjar al voltant del mon a bord de l HMS Beagle. Durant aquesta expedicio va observar fossils, especies de diferents continents i la fauna de les illes Galapagos. Aquestes observacions el van portar a pensar que les especies podien canviar i diversificar-se amb el temps.',
                    feedback: 'Conve relacionar aquest viatge amb l acumulacio d observacions que van portar Darwin a formular la seua explicacio evolutiva.',
                    mediaType: 'image',
                    mediaSrc: 'https://commons.wikimedia.org/wiki/Special:FilePath/HMS%20Beagle%20by%20Conrad%20Martens.jpg',
                    videoSource: 'local',
                    videoUrl: '',
                    posterSrc: '',
                    mediaCaption: 'Pintura de l HMS Beagle',
                },
                {
                    displayDate: '1858',
                    sortKey: '1858',
                    title: 'Darwin i Wallace Presenten la Seleccio Natural',
                    text: 'Charles Darwin i Alfred Russel Wallace van presentar conjuntament la idea de la seleccio natural. Tots dos sostenien que els individus amb variacions favorables tenen mes probabilitat de sobreviure i deixar descendencia, de manera que aquestes caracteristiques es fan mes frequents en la poblacio.',
                    feedback: 'Recorda que Wallace va arribar de manera independent a una idea molt similar a la de Darwin.',
                    mediaType: 'none',
                    mediaSrc: '',
                    videoSource: 'local',
                    videoUrl: '',
                ...
                },
                {
                    displayDate: '1859',
                    sortKey: '1859',
                    title: 'Publicacio de L Origen de les Especies',
                    text: 'Darwin va publicar "L origen de les especies", obra en la qual va explicar que l evolucio ocorre per seleccio natural. En ella defensava que totes les especies descendeixen d avantpassats comuns i que la biodiversitat actual es el resultat de canvis acumulats durant llargs periodes de temps.',
                    feedback: 'Aquest es un dels textos cientifics mes influents de la biologia perque aporta una explicacio general i coherent de l evolucio.',
                    mediaType: 'video',
                    mediaSrc: '',
                    videoSource: 'external',
                    videoUrl: 'https://www.youtube.com/watch?v=dyiZaHIRM6w',
                    posterSrc: '',
                    mediaCaption: 'Video divulgatiu sobre Darwin i la seleccio natural',
                },
                {
                    displayDate: '1865',
                    sortKey: '1865',
                    title: 'Mendel Formula les Lleis de l Herencia',
                    text: 'Gregor Mendel va publicar els resultats dels seus experiments amb pesols. Les seues lleis mostraren que els caracters hereditaris es transmeten de forma definida entre generacions. Decades despres, aquest treball va permetre comprendre millor com es conserva i es transmet la variabilitat biologica.',
                    feedback: 'La genetica mendeliana va ser essencial per a explicar com poden heretar-se les diferencies sobre les quals actua la seleccio natural.',
                    mediaType: 'image',
                    mediaSrc: 'https://commons.wikimedia.org/wiki/Special:FilePath/Gregor%20Mendel%202%20%28cropped%29.jpg',
                    videoSource: 'local',
                    videoUrl: '',
                    posterSrc: '',
                    mediaCaption: 'Retrat de Gregor Mendel',
                },
                {
                    displayDate: '1930-1940',
                    sortKey: '1930',
                    title: 'Sintesi Moderna de l Evolucio',
                    text: 'Durant aquestes decades es van integrar la seleccio natural de Darwin i la genetica mendeliana. La sintesi moderna va explicar l evolucio com un canvi en la frequencia dels allels en les poblacions al llarg del temps i va incorporar processos com la mutacio, la recombinacio, la deriva genetica i la seleccio natural.',
                    feedback: 'Aquest moment uneix evolucio i genetica en una teoria mes completa, base de la biologia evolutiva actual.',
                    mediaType: 'image',
                    mediaSrc: 'https://commons.wikimedia.org/wiki/Special:FilePath/DNA%20double%20helix%20vertikal.PNG',
                    videoSource: 'local',
                    videoUrl: '',
                    posterSrc: '',
                    mediaCaption: 'Representacio de la doble helix de l ADN, relacionada amb l herencia biologica',
                },
            ],
        };
        return (localeSamples[this.lang] || localeSamples.es).map(function (item) {
            return {
                id: this.id(),
                displayDate: item.displayDate,
                sortKey: item.sortKey,
